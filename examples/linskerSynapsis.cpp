...
int main(int argc, char **argv) {
  ...
  // Initialize 2 synapsis between the neurons (h2 will be post-synapstic neuron in both)
  ...
  // std::cout << "Time" << " " << "V1pre" << " " << "V2pre" << " " << "V3pre" << " " << "V4pre" << " " << "Vpost" 
  //             << " " << "i1" << " " << "i2" << " " << "i3" << " " << "i4" << " " << "w1" << " " << "w2" << " " << "w3" << " " << "w4" << " " << "SUM(W)" << std::endl;
  ...
  for (double time = 0; time < simulation_time; time += step) {
    ...
    // Provide an external current input to all neurons
    ...
    std::cout << time << " " << h1.get(HH::v) << " " << h3.get(HH::v) << " " << h2.get(HH::v) << " " << s1.get(Synapsis::i) << " " 
              << s2.get(Synapsis::i) << " " << s1.get(Synapsis::w) << " " << s2.get(Synapsis::w) << " " 
    ...
    // std::cout << time << " " << h1.get(HH::v) << " " << h2.get(HH::v) << " " << s1.get(Synapsis::i)<< " " << s1.get(Synapsis::w) << "\n";
  }
